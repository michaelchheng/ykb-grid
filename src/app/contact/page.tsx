    ...
    <main className="min-h-screen bg-[#08080d] text-white flex items-center justify-center px-5">
      <div className="max-w-sm w-full text-center">
        ...
        <h1 className="text-3xl font-black mb-1">
          Hi, I&apos;m <span className="text-emerald-400">Michael</span>
        </h1>
        ...
        <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-6 text-left space-y-4 mb-8">
          ...
          <div>
            ...
            <a
              ...
              className="text-emerald-400 font-semibold hover:text-emerald-300 transition-colors break-all"
            >
        ...
        <a
          href="/"
          className="inline-block px-8 py-3 rounded-xl bg-emerald-500 text-black font-black text-sm hover:bg-emerald-400 transition-all"
        >
          ← Back to the game
        </a>

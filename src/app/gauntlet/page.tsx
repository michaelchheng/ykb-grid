  ...
  return (
    <div className="min-h-screen bg-[#08080d] text-white flex flex-col">
      ...
      <div className="border-b border-white/[0.06] px-5 py-3 flex items-center justify-between">
        ...
        <div className="text-center">
          <p className="text-[10px] font-mono text-violet-400/70 uppercase tracking-widest">Career Gauntlet</p>
        </div>
        ...
        <div className="max-w-sm w-full">
          ...
          {phase === 'answered' && (
            <div className="mt-6 text-center">
              ...
              <button onClick={next}
                className="mt-3 px-8 py-3 rounded-xl bg-violet-500 text-black font-black text-sm hover:bg-violet-400 transition-colors active:scale-[0.98]">

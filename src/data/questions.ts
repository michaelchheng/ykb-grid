...
export interface Question {
  ...
  valueB: number;
  unit: string;
  difficulty: 'easy' | 'medium' | 'hard' | 'unhinged';
}
...
export const QUESTIONS: Question[] = [
  ...
  { id: 'q_fg_nunn_bullock', era: 'modern', category: 'fg_pct', label: 'Field Goal %', subLabel: '2020-21 regular season', flavor: 'Nunn shot 43.8%, Bullock 43.6%. A 0.2 point difference. If you guessed correctly you need help.', playerA: nunn, playerB: bullock, valueA: 438, valueB: 436, unit: 'FG% x1000', difficulty: 'unhinged' },
  { id: 'q_fg_oubre_burks', era: 'modern', category: 'fg_pct', label: 'Field Goal %', subLabel: '2019-20 regular season', flavor: 'Oubre at 44.3% vs Burks at 44.1%. Two volume shooters on rebuilding teams.', playerA: oubre, playerB: burks, valueA: 443, valueB: 441, unit: 'FG% x1000', difficulty: 'unhinged' },
  { id: 'q_fg_pat_bev_temple', era: 'modern', category: 'fg_pct', label: 'Field Goal %', subLabel: '2019-20 regular season', flavor: 'Defensive specialists forced to shoot. Neither should be taking many attempts.', playerA: pat_bev, playerB: temple, valueA: 402, valueB: 398, unit: 'FG% x1000', difficulty: 'unhinged' },
  { id: 'q_3pt_crabbe_harkless', era: 'modern', category: 'three_point_pct', label: '3-Point %', subLabel: '2017-18 regular season', flavor: 'Crabbe shot 37.2% from three, Harkless 37.0%. Both on max-adjacent deals. Both overpaid.', playerA: crabbe, playerB: harkless, valueA: 372, valueB: 370, unit: '3P% x1000', difficulty: 'unhinged' },
  { id: 'q_ft_theis_nance', era: 'modern', category: 'ft_pct', label: 'Free Throw %', subLabel: '2019-20 regular season', flavor: 'Interior bigs who can actually make free throws. A niche demographic.', playerA: theis, playerB: nance, valueA: 789, valueB: 782, unit: 'FT% x1000', difficulty: 'unhinged' },
  ...
  { id: 'q_pts_melo_dirk', era: 'classic', category: 'points', label: 'Career Points Through Age 34', subLabel: 'All-time career', flavor: 'Dirk had 24,316 points through his age-34 season. Melo had 24,559. Neck and neck.', playerA: melo, playerB: dirk, valueA: 24559, valueB: 24316, unit: 'career points', difficulty: 'unhinged' },

  // CLASSIC: obscure role player niche
  { id: 'q_fg_sedale_blue', era: 'classic', category: 'fg_pct', label: 'Field Goal %', subLabel: '1990-91 regular season', flavor: 'Sedale Threatt shot 45.8% for Seattle. Blue Edwards shot 45.5% for Utah. Two names you absolutely should not know.', playerA: sedale, playerB: blue_e, valueA: 458, valueB: 455, unit: 'FG% x1000', difficulty: 'unhinged' },
  ...
  { id: 'q_blk_foyle_z_mo', era: 'classic', category: 'blocks', label: 'Season Blocks', subLabel: '2001-02 regular season', flavor: 'Adonal Foyle had 163 blocks in 2001-02 from the bench in Golden State. Rebraca had 71 as a backup in Detroit.', playerA: foyle, playerB: z_mo, valueA: 163, valueB: 71, unit: 'blocks', difficulty: 'unhinged' },
  ...
  { id: 'q_gp_hoiberg_bob_h', era: 'classic', category: 'games_played', label: 'Career Games Played', subLabel: 'NBA career totals', flavor: 'Fred Hoiberg played 393 NBA games. Bob Hansen played 388. Two names every fan knows only because of coaching or family.', playerA: hoiberg, playerB: bob_h, valueA: 393, valueB: 388, unit: 'games played', difficulty: 'unhinged' },
  { id: 'q_pf_caffey_chris_m', era: 'classic', category: 'personal_fouls', label: 'Personal Fouls', subLabel: '1996-97 regular season', flavor: 'Jason Caffey had 187 fouls on the Bulls dynasty. Chris Morris fouled 201 times in New Jersey the same year.', playerA: caffey, playerB: chris_m, valueA: 187, valueB: 201, unit: 'personal fouls', difficulty: 'unhinged' },

  // EXTRA NICHE — microscopic gaps
  { id: 'q_fg_nunn_hill', era: 'modern', category: 'fg_pct', label: 'Field Goal %', subLabel: '2021-22 regular season', flavor: 'Nunn shot 44.1%, Hill shot 44.0%. One tenth of a percent. Both are rotation players nobody discusses.', playerA: nunn, playerB: frye, valueA: 441, valueB: 440, unit: 'FG% x1000', difficulty: 'unhinged' },
  { id: 'q_3pt_burks_neto2', era: 'modern', category: 'three_point_pct', label: '3-Point %', subLabel: '2018-19 regular season', flavor: 'Burks shot 35.1%, Neto shot 35.0%. Two backup guards nobody picked in fantasy.', playerA: burks, playerB: neto, valueA: 351, valueB: 350, unit: '3P% x1000', difficulty: 'unhinged' },
  ...
  { id: 'q_pf_hoiberg_bob_h2', era: 'classic', category: 'personal_fouls', label: 'Career Personal Fouls', subLabel: 'NBA career totals', flavor: 'Fred Hoiberg fouled 527 times. Bob Hansen fouled 508. Neither was known for being physical.', playerA: hoiberg, playerB: bob_h, valueA: 527, valueB: 508, unit: 'career fouls', difficulty: 'unhinged' },
  { id: 'q_ft_greg_theis', era: 'modern', category: 'ft_pct', label: 'Free Throw %', subLabel: '2020-21 regular season', flavor: 'Theis shot 79.3%, Nance shot 77.5%. Two bigs who can actually make free throws. Somehow this is unhinged.', playerA: theis, playerB: nance, valueA: 793, valueB: 775, unit: 'FT% x1000', difficulty: 'unhinged' },
  ...
  { id: 'q_reb_ad_jokic', era: 'modern', category: 'offensive_rebounds', label: 'Total Rebounds', subLabel: '2020-21 regular season', flavor: 'AD grabbed 815 total boards, a career season. Jokic had 812 — they were literally one rebound apart.', playerA: ad, playerB: joker_mv3, valueA: 815, valueB: 812, unit: 'rebounds', difficulty: 'unhinged' },
...
export function getQuestionsByDifficulty(difficulty: 'easy' | 'medium' | 'hard' | 'unhinged'): Question[] {

...
// Extra obscure role players for niche questions
const mike_bib  = P('mike_bib',  'Mike Bibby',               'SAC 2002-03',  '#5A2D81');
const lue       = P('lue',       'Tyronn Lue',               'LAL 2001-02',  '#552583');
const swift     = P('swift',     'Stromile Swift',           'MEM 2003-04',  '#5D76A9');
const cato      = P('cato',      'Kelvin Cato',              'HOU 2003-04',  '#CE1141');
const jar_jack  = P('jar_jack',  'Jarrett Jack',             'GSW 2012-13',  '#1D428A');
const jeff_teag = P('jeff_teag', 'Jeff Teague',              'ATL 2014-15',  '#C1D32F');
const lin       = P('lin',       'Jeremy Lin',               'NYK 2011-12',  '#006BB6');
const korver    = P('korver',    'Kyle Korver',              'ATL 2014-15',  '#C1D32F');
const dudley    = P('dudley',    'Jared Dudley',             'PHX 2012-13',  '#E56020');
const ellington = P('ellington', 'Wayne Ellington',          'MIA 2017-18',  '#98002E');
const shaun_l   = P('shaun_l',   'Shaun Livingston',         'GSW 2016-17',  '#1D428A');
const patty_m   = P('patty_m',   'Patty Mills',              'SAS 2015-16',  '#C4CED4');
const leandro   = P('leandro',   'Leandro Barbosa',          'PHX 2006-07',  '#E56020');
const calderon  = P('calderon',  'Jose Calderon',            'TOR 2008-09',  '#CE1141');
const hinrich   = P('hinrich',   'Kirk Hinrich',             'CHI 2007-08',  '#CE1141');
const collison  = P('collison',  'Nick Collison',            'OKC 2012-13',  '#007AC1');
const mo_pete   = P('mo_pete',   'Morris Peterson',          'TOR 2004-05',  '#CE1141');
const chucky_a  = P('chucky_a',  'Chucky Atkins',            'DET 2002-03',  '#C8102E');
export const QUESTIONS: Question[] = [
  ...
  // ── DEEP NICHE — obscure milestone games and micro-gap role players ──────
  { id: 'q_20_10_wilt_russ', era: 'classic', category: 'triple_doubles', label: '20pt+10reb Games', subLabel: '1962-63 regular season', flavor: 'Wilt had 80 games with 20pts and 10rebs. Russell had 73. Two of the greatest big men ever, and neither is obviously correct.', playerA: P('wilt', 'Wilt Chamberlain', 'SFW 1962-63', '#1D428A'), playerB: P('russ_c', 'Bill Russell', 'BOS 1962-63', '#007A33'), valueA: 80, valueB: 73, unit: '20/10 games', difficulty: 'niche' },
  { id: 'q_bibby_hinrich_ast', era: 'classic', category: 'assists', label: 'Season Assists', subLabel: '2005-06 regular season', flavor: 'Mike Bibby had 507 assists for Atlanta. Kirk Hinrich had 496 in Chicago. Two starting PGs, neither on a watchable team.', playerA: mike_bib, playerB: hinrich, valueA: 507, valueB: 496, unit: 'assists', difficulty: 'niche' },
  { id: 'q_lin_calderon_ast', era: 'classic', category: 'assists', label: 'Season Assists', subLabel: '2011-12 regular season', flavor: 'Jeremy Lin had 392 assists during Linsanity. Jose Calderon had 384 quietly in Toronto. Both correct by any measure.', playerA: lin, playerB: calderon, valueA: 392, valueB: 384, unit: 'assists', difficulty: 'niche' },
  { id: 'q_patty_korver_3pm', era: 'modern', category: 'three_point_pct', label: '3-Pointers Made', subLabel: '2015-16 regular season', flavor: 'Korver made 218 threes in Atlanta. Patty Mills made 174 in San Antonio. Both are shooters. Neither is obviously more.', playerA: korver, playerB: patty_m, valueA: 218, valueB: 174, unit: 'threes made', difficulty: 'hard' },
  { id: 'q_lue_chucky_pf', era: 'classic', category: 'personal_fouls', label: 'Personal Fouls', subLabel: '2001-02 regular season', flavor: 'Tyronn Lue fouled 161 times backing up in LA. Chucky Atkins fouled 148 in Detroit. You should not know this.', playerA: lue, playerB: chucky_a, valueA: 161, valueB: 148, unit: 'fouls', difficulty: 'niche' },
  { id: 'q_swift_cato_blk', era: 'classic', category: 'blocks', label: 'Season Blocks', subLabel: '2003-04 regular season', flavor: 'Stromile Swift blocked 133 shots for Memphis. Kelvin Cato blocked 127 in Houston. Two big men nobody drafted in fantasy.', playerA: swift, playerB: cato, valueA: 133, valueB: 127, unit: 'blocks', difficulty: 'niche' },
  { id: 'q_collison_dudley_pf', era: 'modern', category: 'personal_fouls', label: 'Personal Fouls', subLabel: '2012-13 regular season', flavor: 'Nick Collison fouled 147 times in OKC off the bench. Dudley had 138 for Phoenix. Neither started 30 games.', playerA: collison, playerB: dudley, valueA: 147, valueB: 138, unit: 'fouls', difficulty: 'niche' },
  { id: 'q_ellington_shaun_3pm', era: 'modern', category: 'three_point_pct', label: '3-Pointers Made', subLabel: '2017-18 regular season', flavor: 'Wayne Ellington made 227 threes off the bench in Miami. Shaun Livingston made 0. That gap is not a typo.', playerA: ellington, playerB: shaun_l, valueA: 227, valueB: 0, unit: 'threes made', difficulty: 'easy' },
  { id: 'q_leandro_mo_pete_pts', era: 'classic', category: 'points', label: 'Season Points', subLabel: '2006-07 regular season', flavor: 'Leandro Barbosa dropped 1,061 points as the Suns sixth man. Morris Peterson had 812 in Toronto. Bench scoring deep cut.', playerA: leandro, playerB: mo_pete, valueA: 1061, valueB: 812, unit: 'points', difficulty: 'niche' },
  { id: 'q_jar_jack_jeff_teag_ast', era: 'modern', category: 'assists', label: 'Season Assists', subLabel: '2012-13 regular season', flavor: 'Jarrett Jack had 437 assists coming off the bench in Golden State. Jeff Teague had 441 starting in Atlanta. One assist apart.', playerA: jar_jack, playerB: jeff_teag, valueA: 437, valueB: 441, unit: 'assists', difficulty: 'niche' },
  { id: 'q_30pt_ai_tmac_career', era: 'classic', category: 'points', label: 'Career 30-Point Games', subLabel: 'Full NBA career', flavor: 'Iverson had 290 career 30-point games. McGrady had 161 before his back gave out. Both are Hall of Famers. One had way more.', playerA: ai, playerB: tmac, valueA: 290, valueB: 161, unit: 'career 30-pt games', difficulty: 'hard' },
  { id: 'q_drummond_whiteside_oreb', era: 'modern', category: 'offensive_rebounds', label: 'Offensive Rebounds', subLabel: '2017-18 regular season', flavor: 'Drummond had 393 offensive rebounds. Whiteside had 222. Both were starting centers on mediocre teams. One was far more relentless.', playerA: drummond, playerB: whiteside, valueA: 393, valueB: 222, unit: 'offensive boards', difficulty: 'medium' },
  { id: 'q_Capela_gobert_blk', era: 'modern', category: 'blocks', label: 'Season Blocks', subLabel: '2018-19 regular season', flavor: 'Gobert had 199 blocks as the two-time Defensive Player of the Year. Capela had 188 in Houston. Closer than you think.', playerA: gobert, playerB: capela, valueA: 199, valueB: 188, unit: 'blocks', difficulty: 'hard' },
  { id: 'q_porzingis_vucevic_3pm', era: 'modern', category: 'three_point_pct', label: '3-Pointers Made', subLabel: '2017-18 regular season', flavor: 'Porzingis made 124 threes as a shooting big in New York. Vucevic made 63 in Orlando. Both bigs. Very different numbers.', playerA: porzingis, playerB: vucevic, valueA: 124, valueB: 63, unit: 'threes made', difficulty: 'medium' },
  { id: 'q_simmons_career_3pm', era: 'modern', category: 'three_point_pct', label: 'Career 3-Pointers Made', subLabel: 'NBA career totals through 2021', flavor: 'Ben Simmons attempted 11 three-pointers in five NBA seasons and made 1. Rudy Gobert attempted more. This is a real question.', playerA: simmons, playerB: gobert, valueA: 1, valueB: 9, unit: 'career threes made', difficulty: 'easy' },
  { id: 'q_beal_middleton_pts', era: 'modern', category: 'points', label: 'Season Points', subLabel: '2020-21 regular season', flavor: 'Beal dropped 2,131 points to lead the league. Middleton had 1,474 on a title-winning Bucks team. Both All-Stars.', playerA: beal, playerB: middleton, valueA: 2131, valueB: 1474, unit: 'points', difficulty: 'medium' },
